Shader "Custom/ToonShader"
{
    Properties
    {
        ...
        _SSSTex ("Subsurface Map", 2D) = "black"{}
        _SSSColor ("Subsurface Tint", Color) = (1,1,1,1)
        _CombMap ("ILM Map", 2D) = "white" {}
        _SpecPower("Specular Power", Range(0,100)) = 20.0
        _SpecScale("Specular Scale", Range(0,10)) = 1.0
        _OutlineColor("Outline Color", Color) = (0,0.862,0.3725,1)
    ...
    SubShader
    {
        ...
        //Toon shading-----------------------------------------------------------------------------
        CGPROGRAM
        #pragma surface surf ToonLighting // Setting up a custom light function
        ...
        //Affects the lighting and shadows 
        ...
        void surf (Input IN, inout CustomSurfaceOutput  o)
        {
            ...
            o.Glossy = comb.r;
            o.Glossiness = comb.b; //(ILM) Blue channel determines the glossiness?
            o.Shadow = comb.g; //(ILM) Green channel is used to add extra channels
            o.Innerline = comb.a; // Alpha channel used as Inner Line Mask
        }
        ENDCG
    }
    FallBack "Diffuse"
